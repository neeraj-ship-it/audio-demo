 ...
 */
async function getUniqueThumbnail(category) {
  ...
  const recentlyUsed = await getRecentlyUsedThumbnails(category, 5); // Last 5 stories
 ...
 */
async function getRecentlyUsedThumbnails(category, count = 5) {
  try {
