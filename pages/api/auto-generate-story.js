...
// Pipeline: Gemini script → ElevenLabs audio → S3 upload → AI thumbnail → S3 metadata
...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.log('✅ Saved story:', newStory.id)
...
function getEmoji(category) {
  return { Romance: '💕', Horror: '👻', Thriller: '🔪', Comedy: '😂', Spiritual: '🙏', Motivation: '💪' }[category] || '🎵'
}
