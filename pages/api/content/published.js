...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Timeout after 5s to prevent hanging when S3 is unreachable locally
    let liveStories = []
    try {
    ...
    const published = await Promise.all(
      uniqueStories
        ...
        .map(async story => {
          ...
          // Don't set placeholder URL - let frontend gradient fallback handle it
          // Each story gets a unique gradient based on its ID in StoryCard
